...
![GitHubNewRepo](images/GitHubNewRepo.png)
...
![CloneGHRepo](images/HttpsLink2CloneGHRepo.png)
...
![CloneGHRepo2](images/CloneRepo2.png)
...
![CloneGHRepo3](images/CloneRepo3.png)
...
![IndexTemplate](images/IndexTemplate.png)  
...
You can go on with this example at this [link](WorkFlowRExample.html).  
...
![KnitButton](images/KnitRmdFile.png)
...
![RStudioReviewWindow](images/RStudioReview.png)
...
![GitHubPages1](images/GitPage1.png)

Then select the `Pages` section at the sidebar menu
![GitHubPages2](images/GitPage2.png)
...
![GitHubPages3](images/GitPage3.png)
